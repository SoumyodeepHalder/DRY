...
<body>
    <div class="bg-gray-800 bg-blend-multiply bg-[url('/codeimg.jpg')] bg-cover bg-center bg-no-repeat h-screen text-white">
        ...
        <div class="mx-10">
            <h1 class="text-4xl text-center pt-35 mb-20">Login</h1>
            <?php
            ...
            <form action="login.php" method="post" class="flex flex-col">
                ...
                <input type="submit" value="Login" class="bg-orange-500 w-30 h-10 m-auto text-2xl rounded-lg cursor-pointer mb-10">
            </form>
        </div>
    </div>
